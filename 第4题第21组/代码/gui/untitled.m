...
% Last Modified by GUIDE v2.5 18-Aug-2016 21:48:05
...
location.longitude=str2num(get(handles.edit2,'String'));%(经度)
location.latitude=str2num(get(handles.edit3,'String'));%(纬度)
location.altitude=str2num(get(handles.edit4,'String'));%(海拔)
 time.year =str2num(get(handles.edit12,'String'));
 time.month =str2num(get(handles.edit13,'String'));
 time.day = str2num(get(handles.edit14,'String'));
 time.hour = str2num(get(handles.edit15,'String'));
 time.min = str2num(get(handles.edit16,'String'));
 time.sec = str2num(get(handles.edit17,'String'));
 time.UTC=1;
sun = sun_position(time, location);

openfig('result.fig');
h=guihandles;
set(h.edit3,'String',sun.zenith );
set(h.edit4,'String',sun.azimuth);
set(h.edit1,'String',40*rand());
set(h.edit2,'String',40*rand());

axes(h.axes1);
filename='直射图.jpg';
pathname='C:\Users\lrw\Desktop\';
fpath=[pathname filename];%将文件名和目录名组合成一个完整的路径。
imshow(imread(fpath));%用imread读入图片，并用imshow在axes_src上显示。
%axes(handles.axes1)%
%handles.axes1('name','嫦娥一号与月亮、地球关系');%设置标题名字 
% s1=[0:.01:2*pi]; 
