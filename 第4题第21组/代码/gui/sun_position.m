...
% Exemple of use
%
% location.longitude = -105.1786;     %经度
% location.latitude = 39.742476;      %纬度   
% location.altitude = 1830.14;        %海拔高度
% time.year = 2003;
% time.month = 10;
% time.day = 17;  
% time.hour = 12;
...
% sun = 
% 
%      zenith: 50.1080438859849    %太阳角=90-zenith？ 待考证
%      azimuth: 194.341174010338   % 方位角
%
% History
...
%               the code. (changed the 玡levation?field in 玪ocation?structure
%               information to 玜ltitude?, Vincent Roy
